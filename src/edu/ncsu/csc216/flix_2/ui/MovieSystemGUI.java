...
public class MovieSystemGUI extends JFrame implements ActionListener
{
	...
	private JPanel pnlMovies = new JPanel(); // = new JPanel(new CardLayout(1,1));
	...
	/**
	 * Private Method - populates the customer accounts with two dummy customers. It is
	 *    useful for testing.
	 */
	...
	private void setBordersAndPanels() { 
		...
		scpAtHome.setBorder(BorderFactory.createTitledBorder(scpAtHome.getBorder(), CHECKED_OUT_TITLE,
				TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, fontTitles));
		scpReserveQueue.setBorder(BorderFactory.createTitledBorder(scpReserveQueue.getBorder(), RESERVE_QUEUE_TITLE,
				TitledBorder.DEFAULT_JUSTIFICATION, TitledBorder.DEFAULT_POSITION, fontTitles));
	...
	/** 
	 * Private method -- opens a dialog box for entry of new customer username and password.
