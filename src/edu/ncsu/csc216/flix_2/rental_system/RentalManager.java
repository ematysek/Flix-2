...
/**
 * Interface for a rental system where the items for rent are stored in an inventory
 *   and where there are different customers. Items can be reserved, checked out 
